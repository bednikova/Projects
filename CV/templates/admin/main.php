    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=$request->createAbsoluteUrl('#')?>">CV </a>
            ...
            <ul class="nav navbar-right top-nav">
                <?php /* @var $request \Pragmatic\Request */ ?>
                    ...
                    <li <?php echo $request->isActive('home') ? 'class="active"' : '';?> >
                        <a href="<?=$request->createUrl('home', 'index')?>"> Home </a>
                    </li>
                    <li <?php echo $request->isActive('information') ? 'class="active"' : '';?>>
                        <a href="<?=$request->createUrl('information', 'index')?>"> Information</a>
                    </li>
					<li <?php echo $request->isActive('skills') ? 'class="active"' : '';?>>
                        <a href="<?=$request->createUrl('skills', 'index')?>"> Technical skills</a>
                    </li>
					<li <?php echo $request->isActive('user') ? 'class="active"' : '';?>>
                        <a href="<?=$request->createUrl('user', 'index')?>"> Contacts</a>
                    </li>
